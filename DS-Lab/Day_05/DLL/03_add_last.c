...
void add_last(int value)
{
    ...
    {
        newnode->prev= tail; // store address of last node into prev pointer of new node
        tail->next= newnode; // store address of new node into next pointer of last node
        tail= newnode; // store address of new node into tail pointer
    }
