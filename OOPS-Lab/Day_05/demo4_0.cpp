...
class ConstDemo
{
    ...
    // in constant member fun of class we can not modify state of object
        ...
        void display()const
        {
            //this->a=111;  // not alllowed as member fun is constant
            //this->b=222;
            //this->c=333;  not alllowed as c & d are const data members
            //this->d=444;
            cout<<"this->a = "<<this->a<<endl;
...
/*
which functions have this pointer
1. all member of class expect static member fun

which functions dont have have this pointer
1.  global function
2.  friend function
3.  static member fun
